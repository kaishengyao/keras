...
from keras.layers.ExternalMemoryNetworks import RNNEM, RNNEM2bk, RNNEMvec
from keras.datasets import imdb

'''
    Train a RNN-EM on the IMDB sentiment classification task.
    ...
    - RNN-EM loss decrease during training can be quite different
    from what you see with CNNs/MLPs/etc. It's more or less a sigmoid
    instead of an inverse exponential.

    GPU command:
        THEANO_FLAGS=mode=FAST_RUN,device=gpu,floatX=float32 python imdb_rnnem.py
